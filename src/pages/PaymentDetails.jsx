            ...
            <div className=' my-10 p-4 bg-gray-100 dark:bg-gray-900 drop-shadow-2xl bg-opacity-30 border-solid' style={{marginLeft:'500px',marginRight:'500px' , height:'800px'}} >
                <form>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div className='mb-0'>
                            <button type="submit" onClick={routeChange_PaymentGate} class="text-white bg-slate-600 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Procide</button>
                        </div>
                    </div >
