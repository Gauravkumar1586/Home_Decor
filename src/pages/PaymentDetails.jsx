...
const PaymentDetails = () => {
     {/*function for PaymentGate page */}
  let navigate_PaymentGate = useNavigate(); 
  const routeChange_PaymentGate = () =>{ 
    let path = `/PaymentGate`;
    navigate_PaymentGate(path);
  }
    return (
        <>
                ...
                <form className='mt-10'>
                    ...
                    <div className="grid md:grid-cols-2 md:gap-6">
                        ...
                        <div className="relative z-0 w-full mb-6 group">
                            ...
                            <label htmlFor="floating_company" className="peer-focus:font-medium absolute text-sm text-gray-900 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Company (Ex. Google)</label>
                        </div>
                        <div className='mb-0'>
                            <button type="submit" onClick={routeChange_PaymentGate} className="text-white bg-slate-600 hover:bg-green-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-xl w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Procide</button>
                        </div>
                    </div >
